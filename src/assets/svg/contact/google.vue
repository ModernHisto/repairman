...
<template>
  <a href="mailto:obozrebatel@gmail.com" target="_blank" rel="noopener noreferrer">
    <div class="svg-container" @click="copyUserId">
      <svg viewBox="0 0 192 192" xmlns="http://www.w3.org/2000/svg" fill="none">
        <path stroke="currentColor" stroke-linejoin="round" stroke-width="14"
